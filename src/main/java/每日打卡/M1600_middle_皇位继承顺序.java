 ...
 */
public class M1600_middle_皇位继承顺序 {
    ...
    class ThroneInheritance {
        ...
        public void birth(String parentName, String childName) {
            Node parent = nameMap.get(parentName);
        ...
        public void successor(Node x, List<String> order) {
            if (!x.isDeath) {
                order.add(x.name);
            }
            List<Node> childes = x.childes;
